...
#  geom_hline(yintercept = 1, color = "red") +
  ...
  theme(legend.position = "bottom",
        axis.text.x = element_blank(),
        axis.ticks.x = element_blank()) +
  labs(title = "(C) Slope", y = "Slope (absolute deviation from 1)", color = "Configuration")
...
rsq_raw_wetness_test_prep <- mod_boxplots_xconfs %>% 
  filter(approach == "Raw concentrations")
...
rsq_ratio_wetness_test_prep <- mod_boxplots_xconfs %>% 
  filter(approach == "Element ratios")
...
rsq_log_ratio_wetness_test_prep <- mod_boxplots_xconfs %>% 
  filter(approach == "Element log ratios")
...
#1A
table_1a <- tibble(
  "Variable" = c("R squared", "Intercept", "Slope"),
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Kruskal test, difference between the data representations") %>% 
...
table_1b <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Fligner test, difference between the data representations") %>% 
  kable_paper(full_width = TRUE)
...
table_s1a <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Kruskal test, difference between raw concentrations and element ratios") %>% 
  kable_paper(full_width = TRUE)
...
table_s1b <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Kruskal test, difference between raw concentrations and element log ratios") %>% 
  kable_paper(full_width = TRUE)
...
table_s1c <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Kruskal test, difference between element ratios and element log ratios") %>% 
  kable_paper(full_width = TRUE)
...
table_s1d <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Fligner test, difference between raw concentrations and element ratios") %>% 
  kable_paper(full_width = TRUE)
...
table_s1e <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Fligner test, difference between raw concentrations and element log ratios") %>% 
  kable_paper(full_width = TRUE)
...
table_s1f <- tibble(
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Fligner test, difference between element ratios and element log ratios") %>% 
  kable_paper(full_width = TRUE)
...
table_2a <- tibble(
  "Variable" = c("R squared", "Intercept", "Slope"),
  "Raw concentrations" = c(rsq_raw_wetness_test_pval,
                           intc_raw_wetness_test_pval,
                           slp_raw_wetness_test_pval),
  "Element ratios" = c(rsq_ratio_wetness_test_pval,
                       intc_ratio_wetness_test_pval,
                       slp_ratio_wetness_test_pval),
  "Element log ratios" = c(rsq_log_ratio_wetness_test_pval,
                           intc_log_ratio_wetness_test_pval,
                           slp_log_ratio_wetness_test_pval)
) %>% 
  mutate(across(where(is.numeric), ~ round(.x, 3))) %>% 
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Kruskal test, difference between the wetness classes") %>% 
  kable_paper(full_width = TRUE)
...
table_2b <- tibble(
  "Variable" = c("R squared", "Intercept", "Slope"),
  "Raw concentrations" = c(rsq_raw_wetness_test_fk_pval,
                           intc_raw_wetness_test_fk_pval,
                           slp_raw_wetness_test_fk_pval),
  "Element ratios" = c(rsq_ratio_wetness_test_fk_pval,
                       intc_ratio_wetness_test_fk_pval,
                       slp_ratio_wetness_test_fk_pval),
  "Element log ratios" = c(rsq_log_ratio_wetness_test_fk_pval,
                           intc_log_ratio_wetness_test_fk_pval,
                           slp_log_ratio_wetness_test_fk_pval)
) %>% 
  mutate(across(where(is.numeric), ~ round(.x, 3))) %>% 
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Fligner test, difference between the wetness classes") %>% 
  kable_paper(full_width = TRUE)
...
table_3a <- tibble(
  "Variable" = c("R squared", "Intercept", "Slope"),
  "Raw concentrations" = c(rsq_raw_ws_test_pval,
                           intc_raw_ws_test_pval,
                           slp_raw_ws_test_pval),
  "Element ratios" = c(rsq_ratio_ws_test_pval,
                       intc_ratio_ws_test_pval,
                       slp_ratio_ws_test_pval),
  "Element log ratios" = c(rsq_log_ratio_ws_test_pval,
                           intc_log_ratio_ws_test_pval,
                           slp_log_ratio_ws_test_pval)
) %>% 
  mutate(across(where(is.numeric), ~ round(.x, 3))) %>% 
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Kruskal test, difference between the WS classes") %>% 
  kable_paper(full_width = TRUE)
...
table_3b <- tibble(
  "Variable" = c("R squared", "Intercept", "Slope"),
  "Raw concentrations" = c(rsq_raw_ws_test_fk_pval,
                           intc_raw_ws_test_fk_pval,
                           slp_raw_ws_test_fk_pval),
  "Element ratios" = c(rsq_ratio_ws_test_fk_pval,
                       intc_ratio_ws_test_fk_pval,
                       slp_ratio_ws_test_fk_pval),
  "Element log ratios" = c(rsq_log_ratio_ws_test_fk_pval,
                           intc_log_ratio_ws_test_fk_pval,
                           slp_log_ratio_ws_test_fk_pval)
) %>% 
  mutate(across(where(is.numeric), ~ round(.x, 3))) %>% 
  ...
  kbl(booktabs = TRUE,
      ...
      linesep = "",
      escape = FALSE,
      caption = "Fligner test, difference between WS classes") %>% 
  kable_paper(full_width = TRUE)
